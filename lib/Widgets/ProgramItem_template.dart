...
class ProgramItemTemplate extends StatefulWidget {
  ProgramItemTemplate({
    super.key,
    required this.Id,
    required this.title,
  ...
  @override
  State<ProgramItemTemplate> createState() => _ProgramItemTemplateState();
}

class _ProgramItemTemplateState extends State<ProgramItemTemplate> {
  int touchedIndex = -1;
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    ).animate(delay: 2500.ms).shimmer(duration: 1000.ms).flip(),
                  )
                ],
              ))
